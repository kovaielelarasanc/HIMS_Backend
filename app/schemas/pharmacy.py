...
#     status: str
#     created_at: datetime
#     approved_at: Optional[datetime] = None   # <--- small enhancement

#     class Config:
#         orm_mode = True


# # NEW: PO detail + items for list/detail/download
...
# # NEW: GRN detail + items for list/detail/download
...
# # ... rest of your existing schemas (DispenseIn, SaleOut, SaleItemOut, etc.) ...
