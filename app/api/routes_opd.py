...
#     rows = (db.query(FollowUp).options(joinedload(
#         FollowUp.appointment)).filter(
#             FollowUp.source_visit_id == visit_id).order_by(
#                 FollowUp.due_date.asc(), FollowUp.created_at.desc()).all())
...
#             f.id,
#             "due_date":
#             f.due_date.isoformat() if f.due_date else None,
#             "status":
#             f.status,
#             "note":
#             f.note,
...
#             f.appointment_id,
#             "appointment_date":
#             appt.date.isoformat() if appt and appt.date else None,
#             "slot_start":
#             appt.slot_start.strftime("%H:%M")
#             if appt and appt.slot_start else None,
#             "slot_end":
#             appt.slot_end.strftime("%H:%M")
#             if appt and appt.slot_end else None,
#         })
#     return out
...
# #         headers={
# #             "Content-Disposition":
# #             f'inline; filename="opd_summary_{visit_id}.pdf"'
# #         },
# #     )
...
#         user=Depends(current_user),
# ):
#     # optional: enforce permission visits.view if you have RBAC
#     v = db.query(Visit).get(visit_id)
#     if not v:
#         raise HTTPException(status_code=404, detail="Visit not found")
