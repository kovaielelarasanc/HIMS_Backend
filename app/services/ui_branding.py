# FILE: app/services/ui_branding.py
...
def get_or_create_default_ui_branding(
    db: Session,
    ...
    branding = UiBranding(
        ...
        primary_color="#2862e9",  # slate-900
        primary_color_dark="#3352DD",  # slate-950
        sidebar_bg_color="#316df8",
        ...
        pdf_header_height_mm=2,
        pdf_footer_height_mm=2,
